...
예시 형식:
**Specific (구체적)**: 추상적인 목표를 구체적으로 만드는 방법
- 예: "건강해지기" → "주 3회 30분 러닝하기"
- 왜 중요한지: 명확한 목표는 실행 가능성을 높입니다

**Measurable (측정 가능)**: 진행 상황을 확인할 수 있는 지표 설정
- 예: "책 많이 읽기" → "매월 2권 완독하기"
- 왜 중요한지: 측정 가능해야 성취감과 동기부여를 얻을 수 있습니다

**Achievable (달성 가능)**: 현실적인 목표 수립
- 예: 작년 실천율을 고려하여 목표 개수와 난이도 조정
...
- h2 (##) 아래에 직접 내용을 작성하거나, 필요시 h3 (###) 또는 볼드(**) 소제목 사용
- 볼드(**)는 키워드 강조용으로만 사용하고, 제목으로는 사용하지 마세요
- 통계 숫자만 나열하지 말고, 구체적인 목표와 계획을 언급하며 개인화된 피드백 제공
- 격려와 동기부여가 되는 따뜻한 톤 유지
- 실행 가능한 구체적 액션 아이템 제시
- 읽기 편한 구조로 작성 (2단계 위계 유지: h2와 불릿 리스트만)
- 메인 항목은 볼드(**)로 시작하고, 하위 항목은 들여쓰기 2칸 후 '-'로 시작하는 불릿 리스트로 작성하세요
`;
}
