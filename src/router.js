...
class Router {
  ...
  async handleRoute() {
    ...
    try {
      ...
      const timezone = profile?.timezone || 'Asia/Seoul';
      // hash에서 # 제거한 값으로 비교 (예: '/today')
      const hashPath = currentHash.slice(1) || '/today';
      const selectedDate = hashPath === '/today' ? getSelectedDate(timezone) : 'n/a';
          ...
          <div class="auth-container">
            <div class="auth-logo-wrapper">
              ...
              <button id="login-btn" class="auth-login-btn">
                <svg class="mr-4px" width="20" height="20" viewBox="0 0 24 24">
            ...
            <div class="mt-1rem c-danger d-none" id="login-error"></div>
          </div>
        `;
